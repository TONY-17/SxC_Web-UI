<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="purchases.aspx.cs" Inherits="webapp_ui.purchases" %>
					...
					<div class="col-md-12">
						<div class="my_courses_tabs">
							<ul class="nav nav-pills my_crse_nav" id="pills-tab" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active"  href="purchases.aspx" role="tab" aria-controls="pills-my-purchases" aria-selected="true"><i class="uil uil-download-alt"></i>My Purchases</a>
								</li>
								<li class="nav-item">
										...
										<table class="table ucp-table">
											<thead class="thead-s">
												<tr>
													...
													<th class="cell-ta" scope="col">Product Name</th>
													<th class="cell-ta" scope="col">Sold By</th>
