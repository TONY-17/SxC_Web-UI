<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createProducts.aspx.cs" Inherits="webapp_ui.createProducts" %>
			...
			<div class="left_section menu_left" id="js-menu" >
				<div class="left_section">
					<ul>
						...
						<li class="menu--item">
							<a href="createProducts.aspx" class="menu--link active" title="Create Products">
										...
										<div class="step-tab-panel step-tab-info active" id="tab_step1"> 
											<div class="tab-from-content">
												<div class="title-icon">
													<h3 class="title"><i class="uil uil-info-circle"></i>Create Product</h3>
												</div>
											</div>
										</div>
																			...
																			<div class="col-lg-12 col-md-12">
																				<div class="save_content">
																					<div class="alert alert-warning" role="alert" id="warning" runat="server">
																					   upload all  images to avoid this warning
																					</div>
																					<asp:Button  class="upload_btn" title="create  products" style="width: 250px; margin-top:12px; color: #fff; background-color:#fc5f45;" onMouseOver="this.style.background='#333333'" onMouseOut="this.style.background='#fc5f45'"  Text="Upload"  OnClick="UploadFile" runat="server" />
																				</div>
																			</div>
																		</div>
																	</div>
															...
															<div class="col-lg-12">
																<div class="view_info10">
																	<div class="row">
																		...
																		<div class="col-lg-12 col-md-12">
																			<div class="save_content">
                                                                                <asp:Button class="upload_btn" title="create  products" style="width: 250px; margin-top:12px; color: #fff; background-color:#fc5f45;" onMouseOver="this.style.background='#333333'" onMouseOut="this.style.background='#fc5f45'" Text="Save Product" OnClick="createProduct"
																				runat="server" />
																			</div>
																		</div>
																	</div>
