<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentSettings.aspx.cs" Inherits="webapp_ui.PaymentSettings" %>
					...
					<div class="col-lg-12">
						<div class="setting_tabs">
							<ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
								<li class="nav-item">
									<a class="nav-link" style="color:rgb(252, 95, 69);"  href="profile.aspx"  role="tab" aria-selected="false">Account</a>
								</li>
								<li class="nav-item">
									<a class="nav-link active" style="color:rgb(252, 95, 69);"   href="PaymentSettings.aspx" role="tab" aria-selected="true">Payment Settings</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" style="color:rgb(252, 95, 69);"  href="closeAccount.aspx"  role="tab" aria-selected="false">Close Account</a>
								</li>
							</ul>
						</div>
						<div class="tab-content" id="pills-tabContent">
									<div class="tab-pane fade show active" id="pills-bllingpayment" role="tabpanel" aria-labelledby="pills-bllingpayment-tab">
								<div class="account_setting">
									...
									<div class="basic_form">
										...
										<form>
										  ...
										  <div class="form-group">
											...
											<input type="text" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" runat="server">
										  </div>
										  <div class="form-row">
											...
											<div class="form-group col-md-4">
											  <label for="inputState">Province</label>
												<input type="text" class="form-control" id="inputState" runat="server">
											</div>
											<div class="form-group col-md-2">
											  <label for="inputZip">Zip</label>
											  <input type="number" class="form-control" id="inputZip" runat="server">
											</div>
										  </div>
										</form>
												</div>
									...
									<asp:Button  class="upload_btn" style="margin-top:12px; color: #fff; background-color:#fc5f45;" onMouseOver="this.style.background='#333333'" onMouseOut="this.style.background='#fc5f45'" OnClick="EditAddress" Text="Save Changes" runat="server" />
								</div>
							</div>
						</div>
					</div>						
