<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="category.aspx.cs" Inherits="webapp_ui.Category" %>
							...
							<div class="shop_sorting">
								...
								<ul>
									<li>
										...
										<ul>
											<li class="shop_sorting_button" data-isotope-option='{ "sortBy": "original-order" }'><a href="sortcategory.aspx?id=1">Low-High price</a></li>
											<li class="shop_sorting_button" data-isotope-option='{ "sortBy": "name" }'><a href="sortcategory.aspx?id=2">High-Low price</a></li>
										</ul>
									</li>
								</ul>
							</div>
