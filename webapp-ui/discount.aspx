<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="discount.aspx.cs" Inherits="webapp_ui.discount" %>
					...
					<div class="col-md-12">
						<div class="my_courses_tabs">
							<ul class="nav nav-pills my_crse_nav" id="pills-tab" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active"  href="discount.aspx" role="tab" aria-controls="pills-discount" aria-selected="true"><i class="uil uil-tag-alt"></i>Discounts</a>
								</li>
								<li class="nav-item">
									<a class="nav-link"  href="promotions.aspx" role="tab" aria-controls="pills-promotions" aria-selected="false"><i class="uil uil-megaphone"></i>Promotions</a>
								</li>
							</ul>
								...
								<div class="tab-pane fade show active" id="pills-discount" role="tabpanel">
														...
														<div class="col-lg-8">
															<div class="discount_form">
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-6">
																		<div class="ui search focus mt-20 lbel25">
																			<asp:Button class="upload_btn" style="width: 250px; margin-top:12px; color: #fff; background-color:#fc5f45;" onMouseOver="this.style.background='#333333'" onMouseOut="this.style.background='#fc5f45'" Text="Save Changes" OnClick="SaveDiscount"																				runat="server" />		
																		</div>							
																	</div>
																</div>
															</div>
									...
									<div class="table-responsive mt-30">
										<table class="table ucp-table">
											<thead class="thead-s">
												<tr>
													<th class="text-center" scope="col">Offer No.</th>
													<th class="cell-ta">Product Name</th>
