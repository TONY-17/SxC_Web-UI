<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoices.aspx.cs" Inherits="webapp_ui.Invoices" %>
...
<head runat="server">
   <meta charset="utf-8">
		...
		<title>StudentXchange - Dashboard</title>
		...
		<nav class="vertical_nav">
			<div class="left_section menu_left" id="js-menu" >
				<div class="left_section">
					<ul>
						<li class="menu--item">
							<a href="instructor_analyics.html" class="menu--link" title="Dashboard">
						...
						<li class="menu--item active">
							<a href="Invoices.aspx" class="menu--link active" title="Invoices">
		...
		<div class="wrapper">
			<div class="sa4d25">
				<div class="container-fluid">			
					<div class="row">
						<div class="col-lg-12">	
							<h2 class="st_title"><i class="uil uil-file-alt"></i> Invoices</h2>
						</div>					
					</div>				
					<div class="row">					
