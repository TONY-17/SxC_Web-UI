<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="webapp_ui.AdminDashboard" %>
					...
					<div class="col-lg-12">
						<div class="setting_tabs">
							<ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" style="color:rgb(252, 95, 69);"    href="profile.aspx"   aria-selected="true">Account</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" style="color:rgb(252, 95, 69);"   href="PaymentSettings.aspx"  aria-selected="false">Payment Settings</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" style="color:rgb(252, 95, 69);"   href="closeAccount.aspx"  aria-selected="false">Close Account</a>
								</li>
							</ul>
						</div>
						<div class="tab-content" id="pills-tabContent">
								...
								<div class="account_setting">
									<h4>Your studentXchange Account</h4>
									<p>This is your public presence on studentXchange.</p>
												...
												<div class="col-lg-8">
													<div class="row">
														 <div class="col-md-6 mb-3">
															  ...
															  <input type="text" class="form-control" id="inputName"  required runat="server">
															...
															<div class="col-md-6 mb-3">
															  ...
															  <input type="text" class="form-control" id="inputSurn" required runat="server">
															  <div class="valid-feedback">
																Looks good!
															  </div>
														   </div>
														...
														<div class="form-group col-md-12">
														  ...
														  <input type="password" class="form-control" id="inputCPassword" runat="server">
														</div>
														<div class="alert alert-danger" role="alert" id="alertid" runat="server">
														...
														<div class="col-lg-12">
															<div class="ui search focus mt-10">																
																<div class="ui form swdh30">
																	<div class="field">
																		<textarea rows="3" name="description" id="id_description" placeholder="Write a little description about you..." runat="server"></textarea>
																	</div>
																</div>
															</div>
														</div>
									...
									<asp:Button class="upload_btn" style="margin-top:12px; color: #fff; background-color:#fc5f45;" onMouseOver="this.style.background='#333333'" onMouseOut="this.style.background='#fc5f45'" Text="Save Changes" OnClick="EditInfo" runat="server" />
								</div>
							</div>
						</div>
					</div>						
