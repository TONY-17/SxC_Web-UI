<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createdProducts.aspx.cs" Inherits="webapp_ui.AdminProducts" %>
					...
					<div class="col-md-12">
						<div class="my_courses_tabs">
							<ul class="nav nav-pills my_crse_nav" id="pills-tab" role="tablist">
								<li class="nav-item">
									<a class="nav-link active"  href="createdProducts.aspx" role="tab" aria-controls="pills-my-courses" aria-selected="true"><i class="uil uil-book-alt"></i>My Products</a>
								</li>
								<li class="nav-item">
								...
								<div class="tab-pane fade show active" id="pills-my-courses" role="tabpanel">
									<div class="table-responsive mt-30">
										<table class="table ucp-table">
											<thead class="thead-s">
												<tr>
													<th class="text-center" scope="col">Product No.</th>
													<th>Product Name</th>
